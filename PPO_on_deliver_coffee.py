...
Task:
 ...
 - generate one env_worker; execute PPO on it
    ...
    def thunk(_env_ctx: EnvContext):
        if (capture_video or _env_ctx.get("capture_video")) and idx == 0:
            env = gym.make(env_id, render_mode="rgb_array",
                           params={"generation": "random", "environment_seed": SEED,
...
tune.register_env(
    f"env", make_env('gym_subgoal_automata:OfficeWorldDeliverCoffee-v0', 0, True, "test")
)
