from ...ilasp_common import generate_injected_block
from ..utils.ilasp_task_generator_state import get_state_names, get_state_priorities
...
def _generate_bfs_symmetry_breaking_rules_alternative(max_disj_size):
    ...
    # stmts.append(":- injected_used_state_id(U, I), not injected_used_state_id(U, I-1), I>0.") 
