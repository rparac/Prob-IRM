...
from ray.rllib.examples._old_api_stack.models.mobilenet_v2_encoder import MobileNetV2EncoderConfig
...
class NewCustomNet(PPOTorchRLModule):
    ...
    def setup(self):
        self.setup_architecture(self.config.model_config_dict["num_rm_states"])

    def setup_architecture(self, num_rm_states):
        # super().setup()
