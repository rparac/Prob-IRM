...
from rm_marl.new_stack.env.visual_minecraft.finite_state_machine import MooreMachine
...
class GridWorldEnv(gym.Env):
    ...
    def __init__(self, formula, render_mode="human", state_type="symbolic", use_dfa_state=True, train=True, size=4):
        ...
        dir_prefix = f"/home/rp218/rm-marl/rm_marl/new_stack/env/visual_minecraft/imgs"
        ...
        if state_type == "image":
            ...
            self.stdev, self.mean = torch.std_mean(all_img_tens, dim=0)
