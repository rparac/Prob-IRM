"""
Mining environment from the Noisy Symbolic Abstractions for Deep RL: A case study with Reward Machines by Li et al.

It is a very simple environment for single agents.
"""
