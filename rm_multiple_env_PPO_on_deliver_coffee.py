...
from rm_marl.trainer.new_ray_utils.algo import PPORMConfig
...
dummy_env = NewGymSubgoalAutomataAdapter(gym.make('gym_subgoal_automata:OfficeWorldDeliverCoffee-v0'))
